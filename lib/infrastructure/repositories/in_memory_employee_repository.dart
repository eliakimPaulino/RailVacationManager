...
class InMemoryEmployeeRepository implements EmployeeRepository{
  ...
  @override
  Future<Result<Employee, Failure>> getById(EmployeeId id) async{
    final e = _store[id.value];
    if (e == null) return Result.failure(NotFoundFailure('Employee with id ${id.value} not found'));
